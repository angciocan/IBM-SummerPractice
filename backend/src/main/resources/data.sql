...
insert into course(day_of_week,max_students,study_year,time,teacher_id,category,course_name) values (5,23,3,'17:00',1,'elective','microeconomie');
insert into course(day_of_week,max_students,study_year,time,teacher_id,category,course_name) values (6,23,3,'17:00',1,'elective','management');
