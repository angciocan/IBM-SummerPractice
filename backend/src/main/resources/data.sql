insert into student(grade,admin,study_year,id,faculty_section,name) values (10,true,4,11,'CTI','Robert');
insert into student(grade,admin,study_year,id,faculty_section,name) values (7,false,3,23,'CTI','Angleo');
insert into student(grade,admin,study_year,id,faculty_section,name) values (8,true,2,47,'IS','Mircea');
--
insert into teacher(admin,id,name) values (true,4,'Nicolina');
-- --
